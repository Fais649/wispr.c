...
Display::Display()
{
    ...
    epd_driver = &M5.Display; // Assuming M5.Display is the M5GFX instance for the display
}
...
void Display::drawBitmap(int32_t x, int32_t y, const uint8_t *bitmap, int32_t w, int32_t h, uint16_t color)
{
    lock();
...
void Display::drawTriangle(int32_t x0, int32_t y0, int32_t x1, int32_t y1, int32_t x2, int32_t y2, uint32_t color)
{
    lock();
...
void Display::fillTriangle(int32_t x0, int32_t y0, int32_t x1, int32_t y1, int32_t x2, int32_t y2, uint32_t color)
{
    lock();
