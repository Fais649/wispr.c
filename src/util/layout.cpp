...
float dock_x_abs = (display_width * 0.5) - ((dock_width_abs + dock_right_width_abs + dock_hor_margin_abs) * 2);
...
float dock_right_content_x_padding_abs = dock_right_content_padding * dock_right_width_abs * 0.5;
float dock_right_content_y_padding_abs = dock_right_content_padding * dock_right_height_abs * 2;
float dock_right_border_radius_abs = dock_right_border_radius * dock_right_height_abs;
...
float window_height_abs = display_height - window_y_abs - window_ver_margin_abs - dock_height_abs - (dock_ver_margin_abs * 2);

float window_content_x_padding_abs = window_content_x_padding * window_width_abs;
float window_content_y_padding_abs = window_content_y_padding * window_height_abs;
...
float window_content_width_abs = window_width_abs  - 2 * window_content_x_padding_abs;
float window_content_height_abs = window_height_abs - 2 * window_content_y_padding_abs;
float window_content_x_indent_abs = window_content_width_abs * window_content_x_indent;
float window_content_title_height_abs = window_content_title_height * window_content_height_abs;
float window_content_text_line_height_abs = (window_content_height_abs - window_content_title_height_abs) / window_content_text_lines;
