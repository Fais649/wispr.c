...
void WindowManager::addWindow(Application *app) { windows.push_back(app); }

bool WindowManager::hasActiveWindow() { return activeWindow != nullptr; }
...
void WindowManager::setDirty() { isDirty = true; }