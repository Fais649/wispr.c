...
void Todo::drawText()
{
    ...
    display.setWindow(rectX, rectY + rectHeight - inputHeight, rectWidth, inputHeight);
    display.setTextSize(4);
    display.setTextColor(TFT_WHITE);
    display.fillRect(rectX + 2 * paddingX, rectY + rectHeight - inputHeight - 2 * paddingY, rectWidth - 4 * paddingX, inputHeight, TFT_BLACK);
    display.drawString(_task, rectX + 2 * paddingX, rectY + rectHeight - inputHeight - 2 * paddingY);
    display.display();
    _newKey = false;
}
...
{
    display.setEpdMode(epd_fastest);
    display.fillRoundRect(rectX - paddingX / 3, rectY + paddingY / 3, rectWidth, rectHeight, 25, TFT_DARKGRAY);
    display.fillRoundRect(rectX, rectY, rectWidth, rectHeight, 25, TFT_WHITE);
    display.fillRoundRect(rectX + paddingX, rectY + paddingY, rectWidth - (2 * paddingX), rectHeight - (2 * paddingY), 15, TFT_BLACK);
